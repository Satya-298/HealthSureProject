...
<f:view>
    <h:form>
        <h2><h:outputText value="Cancelled Appointments" /></h2>

        <h:commandButton value="Load Cancelled Appointments"
                         action="#{appointmentController.loadCancelledAppointments}" />
        ...
        <h:dataTable value="#{appointmentController.allAppointments}" var="appt"
            ...
            <h:column>
                ...
                <h:outputText value="#{appt.status}" styleClass="cancelled" />
            </h:column>
            <h:column>
