...
<f:view>
    <h:form>
        <h2><h:outputText value="Appointment History" /></h2>

        <h:commandButton value="Load Appointments" action="#{appointmentController.loadAllAppointments}" />
        ...
        <h:dataTable value="#{appointmentController.allAppointments}" var="appt"
            ...
            <h:column>
                ...
                <h:outputText value="#{appt.status}" styleClass="#{appt.status.toString().toLowerCase()}" />
            </h:column>

            <h:column>
                <f:facet name="header">
                    <h:outputText value="Slot No" />
                </f:facet>
